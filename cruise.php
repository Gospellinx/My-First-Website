...
$query="INSERT INTO photos.cruise(name, email, subject, message) VALUES ('$name', '$email', '$subject', '$message')";
$tom = mysqli_query($handle_event, $query);
if($tom == true){
echo "<script>alert('Information:Message sent successfully')</script>";
}
else{
echo "<script>alert('Information:Message sent failed')</script>";
}
}
...
<head>
    ...
    <title>Execution - Corporate Category Bootstrap Responsive Website Template - Contact : W3Layouts</title>
    <!-- google-fonts -->
                    ...
                    <div class="row main-cont-sec">
                        ...
                        <div class="col-md-6 right-cont-contact">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="message" id="w3lMessage" placeholder=""
                                    required=""></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group-2 mt-3 text-right">
                        <button type="submit" class="btn btn-style" name="create">Submit Form</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="sub-contact mt-5 pt-lg-4">
                <div class="row">
                    <div class="col-md-4 footer-contact d-flex align-items-center">
                        ...
                        <div>
                            <a href="mailto:info@example.com">Gospelocheni@gmail.com</a>
                            <p>Drop Us a Line</p>
                        </div>
                    </div>
                    <div class="col-md-4 footer-contact d-flex align-items-center active">
                        ...
                        <div>
                            <a href="tel:+44-000-888-999">+234-905-592-6358</a>
                            <p>Call Us Now</p>
                        </div>
                    </div>
                    <div class="col-md-4 footer-contact d-flex align-items-center">
                        ...
                        <div>
                            <h5>Opposite stella maris nursery and primary school, Area 1 garki Abuja.</h5>
                            <p>Get Direction</p>
                        </div>
                    </div>
                </div>
